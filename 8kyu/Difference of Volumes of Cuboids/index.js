...
consist of 3 positive integers above 0, representing the dimensions of cuboids a and b. You must find the difference of
...
function findDifference(a, b) {
    var firstCuboids, secondCuboids, result;
    firstCuboids = a[0] * a[1] * a[2];
    secondCuboids = b[0] * b[1] * b[2];

    if (firstCuboids > secondCuboids){
        result = firstCuboids - secondCuboids;
    } else {
        result = secondCuboids - firstCuboids;
    }
