...
For Haskell, body has the type of String and tail has the type of Char. For Go, body has type string and tail has type
rune.*/
...
function correctTail(bod, tail) {
    ...
    var sub = bod.substring(bod.length-(tail.length));
